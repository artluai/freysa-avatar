...
document.addEventListener("pointerdown", closeOpenSelectMenus);
...
function closeOpenSelectMenus(event) {
...
async function speakReply(text, { onSpeechStart } = {}) {
  ...
  if (
    ...
    const speech = await requestElevenLabsSpeech(text, speechRate);
