...
- After five sponsored ElevenLabs responses, the composer is replaced by a one-click Freysa-on-X prompt. A successful unlock restores the composer with five additional responses for the day. After all ten are used, the composer offers a personal ElevenLabs key or Microsoft TTS instead.
